 ...
 */
    ...
    public static void main(String[] args) {
        ...
        int k = 3;
        int threshold = 4;
        System.out.println(numOfSubArary(arr, k, threshold));
    }

    public static int numOfSubArary(int[] arr, int k, int threshold){
