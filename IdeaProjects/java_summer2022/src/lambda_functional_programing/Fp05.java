...
public class Fp05 {
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println(ortalamaPuanaGoreSiralaVeIlkVerienleriAtla(coursesList, 3));
    }
...
//4) Liste öğelerini artan düzende ortalama puana göre sıralayın ve ilk verilenleri atlayın
    public static List<Courses> ortalamaPuanaGoreSiralaVeIlkVerienleriAtla(List<Courses>list,int x){
